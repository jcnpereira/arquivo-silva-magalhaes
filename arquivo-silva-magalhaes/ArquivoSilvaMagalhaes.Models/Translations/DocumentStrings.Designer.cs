...
namespace ArquivoSilvaMagalhaes.Models.Translations {
    ...
    public class DocumentStrings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to O formato do código do documento tem que respeitar o seguinte formato: Coleção-Documento (Ex: ASM-1 ou PAS-002). Pode conter também os símbolos . / _ - : ;.
        /// </summary>
