...
namespace ArquivoSilvaMagalhaes.Models.ArchiveModels {
   ...
   public class Collection {
      ...
      /// collection.
      /// </summary>
      [Required(ErrorMessage = "O {0} é de preenchimento obrigatório"), StringLength(100), Index(IsUnique = true)]
      [Display(ResourceType = typeof(CollectionStrings), Name = "CatalogCode")]
      [RegularExpression("[0-9A-Za-z/_:.;-]+", ErrorMessageResourceType = typeof(CollectionStrings), ErrorMessageResourceName = "AlphanumericCode")]
