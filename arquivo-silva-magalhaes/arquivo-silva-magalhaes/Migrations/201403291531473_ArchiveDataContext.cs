namespace ArquivoSilvaMagalhaes.Migrations
{
    ...
    public partial class ArchiveDataContext : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SpecimenTexts", "SpecimenId", "dbo.Specimen");
            ...
            DropForeignKey("dbo.ClassificationTexts", "ClassificationId", "dbo.Classifications");
            ...
            DropForeignKey("dbo.CollectionTexts", "CollectionId", "dbo.Collections");
            ...
            DropForeignKey("dbo.AuthorTexts", "AuthorId", "dbo.Authors");
            ...
            DropIndex("dbo.SpecimenTexts", new[] { "SpecimenId" });
            ...
            DropIndex("dbo.ClassificationTexts", new[] { "ClassificationId" });
            ...
            DropIndex("dbo.CollectionTexts", new[] { "CollectionId" });
            DropIndex("dbo.AuthorTexts", new[] { "AuthorId" });
