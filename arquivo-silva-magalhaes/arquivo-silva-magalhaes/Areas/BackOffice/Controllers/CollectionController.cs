...
namespace ArquivoSilvaMagalhaes.Areas.BackOffice.Controllers
{
    public class CollectionController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include="Id,Provenience,Dimension,HistoricalDetails,Type,ProductionDate")] Collection collection)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include="Id,Provenience,Dimension,HistoricalDetails,Type,ProductionDate")] Collection collection)
        {
            if (ModelState.IsValid)
            {
